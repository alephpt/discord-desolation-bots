        ...
        async getStats(msg, race) {
            ...
            if (race != "half-blood"){
                ...
                if (choice.toLowerCase() === "yes"){
                    // get stats from race
                    stat.strength = statdata?.stats_level.STRENGTH;
                    stat.dexterity = statdata?.stats_level.DEXTERITY;
                    stat.stamina = statdata?.stats_level.STAMINA;
                    stat.intelligence = statdata?.stats_level.INTELLIGENCE;
                } 

                stat.max_health = statdata?.stats_level.MAX_HEALTH;
                stat.current_health = stat.max_health;
                stat.max_energy = statdata?.stats_level.MAX_ENERGY;
